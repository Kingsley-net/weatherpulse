...
export function Home() {
  ...
  return (
    <div className="h-full w-full custom-bg gap-2 p-2 box-border overflow-hidden fixed">
      ...
      <div className="col-span-2 fixed bottom-0 right-0 left-0 bg-gradient-to-r from-sky-100 via-blue-100 to-indigo-100 shadow-2xl backdrop-blur-lg rounded-t-xl h-auto flex justify-around items-center z-40">
        {navItems.map((nav) => (
          <button
            key={nav.id}
